export const courseModules = [
    {
        ...
        slug: "foundations",
        desc: "Los modelos mentales prerrequisito para el éxito.",
        chapters: [
            {
                title: "Introducción: La Nueva Era",
                slug: "intro-new-era",
                content: `
                    <h3>El Cambio Ya Ha Ocurrido</h3>
                    <p>Hay un momento en cada revolución tecnológica cuando los primeros usuarios dejan de ser raros y empiezan a ser ricos. Estamos en ese momento ahora mismo.</p>
                    <p>Las personas que leen este manual caen en una de dos categorías: aquellos que sienten que el suelo bajo ellos se está moviendo y quieren entender por qué, y aquellos que ya han comenzado a construir en el nuevo terreno y quieren moverse más rápido. Ambos son válidos. Ambos serán atendidos.</p>
                    <p>Pero seamos claros sobre lo que ha cambiado: <strong>Ya no estamos en la Era de la Información. Estamos en la Era de la Síntesis.</strong></p>
                    <p>En la Era de la Información, la persona con más datos ganaba. Las bibliotecas eran poder. Google era el gran igualador. Si podías <em>encontrar</em> la respuesta, podías competir.</p>
                    <p>Esa era ha terminado.</p>
                    <p>Hoy, todos tienen los mismos datos. Cada competidor puede encontrar el mismo tutorial, leer el mismo artículo de investigación, acceder a la misma documentación de API. <strong>El cuello de botella ya no es el conocimiento. El cuello de botella es la estructura.</strong></p>
                    <p>¿Puedes tomar información cruda y sintetizarla en un producto funcional? ¿Puedes tomar una idea de negocio vaga y convertirla en una aplicación desplegada en 48 horas? ¿Puedes tomar diez fuentes de datos desconectadas y tejerlas en una estrategia coherente?</p>
                    <p>Ese es el nuevo juego. Y la IA es el motor que lo hace posible.</p>

                    <h3>Lo Que La IA Ya Puede Hacer (Que La Mayoría Ignora)</h3>
                    <p>Dejemos de lado la exageración y expongamos los hechos. Al momento de escribir esto, la IA puede:</p>
                    <ul>
                        <li><strong>Escribir código listo para producción</strong> más rápido que cualquier desarrollador humano individual, en prácticamente cualquier lenguaje de programación.</li>
                        <li><strong>Diseñar interfaces de usuario</strong> a partir de una descripción de una sola frase, completa con diseños responsivos y consideraciones de accesibilidad.</li>
                        <li><strong>Redactar estrategias comerciales</strong>, análisis de mercado e informes competitivos que a una firma de consultoría le tomaría semanas producir.</li>
                        <li><strong>Generar contenido a escala industrial</strong> - artículos, publicaciones sociales, secuencias de correo electrónico, guiones de video - con un nivel de consistencia que los equipos humanos luchan por igualar.</li>
                        <li><strong>Depurar sistemas complejos</strong> analizando registros, seguimientos de pila y documentación simultáneamente.</li>
                        <li><strong>Aprender nuevos dominios</strong> en tiempo real ingiriendo documentación y adaptando sus respuestas en consecuencia.</li>
                    </ul>
                    <p>Y sin embargo, la gran mayoría de las personas que interactúan con la IA se van <em>decepcionadas</em>.</p>
                    <p>Dicen cosas como: Solo da respuestas genéricas. Inventó información. No pudo hacer lo que realmente necesitaba.</p>
                    <p>No están equivocados. Pero tampoco están viendo el panorama completo.</p>
                    
                    <h3>El Verdadero Problema: Mentalidad de Chat vs. Mentalidad de Sistema</h3>
                    <p>Aquí está la verdad incómoda: <strong>La IA no recompensa la inteligencia. Recompensa la claridad y la estructura.</strong></p>
                    <p>La mayoría de la gente se acerca a la IA con lo que llamo la Mentalidad de Chat. La tratan como una versión más inteligente de Google - un motor de búsqueda con opiniones. Escriben indicaciones vagas, esperan magia y se frustran cuando la magia no aparece.</p>
                    <p>Esto es como darle a alguien un taladro eléctrico y pedirle que haga algo bonito. La herramienta es extraordinaria. La instrucción no vale nada.</p>
                    <p>Los profesionales operan de manera diferente. Tienen lo que llamo la Mentalidad de Sistema. Tratan a la IA como a un ingeniero junior - capaz, entusiasta, pero que requiere especificaciones claras y restricciones definidas.</p>
                    
                    <div class="glass-panel" style="padding: 1.5rem; margin: 1.5rem 0;">
                        <p style="margin-bottom: 0.5rem;"><strong>El Aficionado:</strong></p>
                        <ul style="margin-bottom: 1rem;">
                            <li>Trata a la IA como a un Google con opiniones</li>
                            <li>Escribe prompts vagos (Ayúdame con mi startup)</li>
                            <li>Espera magia</li>
                            <li>Culpa a la herramienta cuando falla</li>
                        </ul>
                        <p style="margin-bottom: 0.5rem;"><strong>El Arquitecto:</strong></p>
                        <ul>
                            <li>Trata a la IA como a un ingeniero junior</li>
                            <li>Diseña restricciones antes de pedir resultados</li>
                            <li>Divide el trabajo en etapas verificables</li>
                            <li>Es dueño del resultado, usa la herramienta</li>
                        </ul>
                    </div>

                    <h3>El Cambio Central</h3>
                    <p>Este es el salto mental que separa a los aficionados de los profesionales.</p>
                    <p>Cuando te sientas frente a tu computadora, ¿piensas: Qué debería preguntarle a la IA hoy?</p>
                    <p>¿O piensas: Qué sistema estoy diseñando? ¿Cuáles son los componentes? ¿Qué maneja la IA y qué manejo yo?</p>
                    <p>La primera pregunta conduce a un trabajo disperso y reactivo. Haces una pregunta, obtienes una respuesta, haces otra pregunta, te confundes, empiezas de nuevo.</p>
                    <p>La segunda pregunta conduce a un <strong>apalancamiento compuesto</strong>. Construyes un sistema una vez y funciona para ti repetidamente. Defines un flujo de trabajo y la IA lo ejecuta a escala.</p>
                    <p>Este manual trata sobre el segundo camino.</p>

                    <h3>Una Palabra sobre Para Quién es este Manual</h3>
                    <p>Esta no es una guía para principiantes sobre ChatGPT. Hay miles de esas, y la mayoría quedan obsoletas en meses.</p>
                    <p>Este manual es para personas que quieren <strong>construir cosas reales</strong>. Aplicaciones. Negocios. Flujos de trabajo automatizados. Productos que generan ingresos.</p>
                    <p>Asume que estás dispuesto a aprender. No asume que ya sabes programar, aunque aprenderás lo suficiente para ser peligroso. No asume que tienes un trasfondo técnico, aunque desarrollarás intuición técnica.</p>
                    <p>Lo que sí asume es que hablas en serio. Que estás cansado del contenido superficial. Que quieres los modelos mentales y las habilidades prácticas que realmente separan a las personas que <em>usan</em> la IA de las personas que <strong>construyen con</strong> IA.</p>

                    <blockquote style="border-left: 4px solid #4f46e5; padding-left: 1rem; font-style: italic; margin: 1.5rem 0;">
                        El objetivo no es usar IA. El objetivo es volverse peligroso con ella.
                    </blockquote>

                    <h3>Lo Que Aprenderás</h3>
                    <p>Al finalizar este manual, entenderás:</p>
                    <ul>
                        <li>Cómo pensar en <strong>sistemas</strong>, no en prompts</li>
                        <li>Cómo diseñar <strong>flujos de trabajo</strong> que aprovechen la IA en cada etapa</li>
                        <li>Cómo construir y desplegar <strong>aplicaciones reales</strong> sin una década de experiencia en programación</li>
                        <li>Cómo <strong>validar y depurar</strong> resultados generados por IA (porque te mentirá)</li>
                        <li>Cómo <strong>monetizar</strong> tus nuevas capacidades, como freelancer, consultor o creador de productos</li>
                        <li>Cómo mantenerte a la vanguardia a medida que la tecnología continúa evolucionando a un ritmo sin precedentes</li>
                    </ul>
                    ...
                    <div class="glass-panel" style="padding: 1.5rem; margin: 2rem 0; background: linear-gradient(135deg, rgba(79,70,229,0.1) 0%, rgba(147,51,234,0.1) 100%);">
                        <h4 style="margin-top: 0;">Hoja de Ruta de Inicio Rápido</h4>
                        <ul>
                            <li><strong>Cambio de Mentalidad:</strong> Ya no eres un mecanógrafo. Eres un diseñador de sistemas.</li>
                            <li><strong>Primera Pregunta:</strong> ¿Cuál es el resultado que necesito? (No: ¿Qué debería preguntar?)</li>
                            <li><strong>Regla Clave:</strong> La IA recompensa la estructura, no la inteligencia. Sé preciso.</li>
                            <li><strong>Acción:</strong> Antes de tu próxima sesión de IA, escribe tu objetivo en una frase.</li>
                        </ul>
                    </div>
                    <p>Esta es la base. Construyamos.</p>
                `
            },
            {
                title: "El 'Por Qué': Ingeniería de Sistemas",
                slug: "why-system-engineering",
                content: `
                    <h3>La Trampa en la que Todos Caen: Ingeniería de Prompts</h3>
                    <p>Probablemente hayas escuchado el término ingeniería de prompts cien veces. Hay cursos sobre ello. Libros. Certificaciones. Y permítanme ser claro: la ingeniería de prompts es útil. Es una habilidad real.</p>
                    <p>Pero también es incompleta. Y si te detienes ahí, nunca construirás nada que importe.</p>
                    <p>Aquí está el problema: <strong>La ingeniería de prompts no tiene estado (stateless).</strong></p>
                    <p>Un solo prompt, por hermoso que sea, no puede construir un producto real. No puede mantener la coherencia a través de una base de código compleja. No puede depurarse a sí mismo cuando algo sale mal. No puede recordar lo que hiciste ayer y retomar donde lo dejaste.</p>
                    <p>La ingeniería de prompts es como gritar instrucciones a una fábrica <em>una vez</em> y esperar que el producto salga perfecto. A veces funciona. Usualmente no. Y cuando falla, no tienes idea de por qué.</p>

                    <h3>El Desbloqueo: Pensar en Tuberías (Pipelines)</h3>
                    <p>Los profesionales no escriben mejores prompts. Construyen mejores <strong>tuberías</strong>.</p>
                    <p>Una tubería es una secuencia de pasos donde la salida de un paso se convierte en la entrada del siguiente. Es cómo funcionan las fábricas. Es cómo se construye el software. Y es cómo deberías pensar sobre la IA.</p>
                    
                    <div class="glass-panel" style="padding: 1.5rem; margin: 1.5rem 0;">
                        <p><strong>Ejemplo (El Enfoque Aficionado):</strong></p>
                        <p style="font-style: italic; color: #888;">Constrúyeme una app SaaS que permita a los usuarios rastrear sus objetivos de fitness...</p>
                        <p>Resultado: Un desastre de código que más o menos funciona, quizás, si entrecierras los ojos.</p>
                        
                        <p style="margin-top: 1.5rem;"><strong>Ejemplo (El Enfoque Profesional):</strong></p>
                        <ol>
                            <li><strong>Paso 1:</strong> Definir la especificación del producto (¿Cuáles son las características? ¿Cuáles son las restricciones?)</li>
                            <li><strong>Paso 2:</strong> Generar el esquema de base de datos (¿Qué datos almacenamos? ¿Cómo se estructuran?)</li>
                            <li><strong>Paso 3:</strong> Generar la capa de API (¿Cómo leemos y escribimos datos?)</li>
                            <li><strong>Paso 4:</strong> Generar el esqueleto de UI (¿Qué ve el usuario?)</li>
                            <li><strong>Paso 5:</strong> Integrar y probar (¿Realmente funciona?)</li>
                        </ol>
                        <p>Resultado: Un sistema que entiendes, puedes depurar y puedes extender.</p>
                    </div>
                    
                    <p>La diferencia no es solo calidad. Es <strong>control</strong>. Cuando construyes en etapas, puedes verificar cada etapa antes de pasar a la siguiente.</p>

                    <blockquote style="border-left: 4px solid #4f46e5; padding-left: 1rem; font-style: italic; margin: 1.5rem 0;">
                        La IA escala linealmente. Los humanos fallan exponencialmente. Las tuberías invierten esa ecuación.
                    </blockquote>

                    <h3>Modelo Mental: IA como Compilador</h3>
                    <p>Aquí está el modelo mental que cambiará cómo trabajas con la IA: <strong>Trata a la IA como un compilador de intención.</strong></p>
                    <p>Un compilador toma código legible por humanos y lo transforma en algo que la máquina puede ejecutar. Si tu código es vago o tiene errores, el compilador falla. Si tu código es preciso y correcto, el compilador produce un programa funcional.</p>
                    <p>La IA funciona de la misma manera:</p>
                    <ul>
                        <li><strong>Intención vaga</strong> conduce a resultados rotos</li>
                        <li><strong>Especificación clara</strong> conduce a resultados confiables</li>
                    </ul>
                    <p>Tu trabajo no es ser creativo con tus prompts. Tu trabajo es ser <strong>preciso</strong>.</p>

                    <h3>Los Tres Niveles del Trabajo con IA</h3>
                    <div class="glass-panel" style="padding: 1.5rem; margin: 1.5rem 0;">
                        <p><strong>Nivel 1: Chat</strong> - Haces preguntas a la IA. Te da respuestas. Aquí es donde la mayoría de la gente se queda para siempre.</p>
                        <p style="margin-top: 1rem;"><strong>Nivel 2: Cadenas de Prompts</strong> - Divides tareas complejas en secuencias de prompts. Empiezas a construir cosas que realmente funcionan.</p>
                        <p style="margin-top: 1rem;"><strong>Nivel 3: Sistemas</strong> - Diseñas flujos de trabajo automatizados donde la IA es un componente entre muchos. Construyes productos que funcionan sin ti.</p>
                    </div>
                    <p>Este manual está diseñado para llevarte del Nivel 1 al Nivel 3.</p>
                    
                    <div class="glass-panel" style="padding: 1.5rem; margin: 2rem 0; background: linear-gradient(135deg, rgba(79,70,229,0.1) 0%, rgba(147,51,234,0.1) 100%);">
                        <h4 style="margin-top: 0;">Hoja de Ruta de Inicio Rápido</h4>
                        <ul>
                            <li><strong>Detente:</strong> Deja de tratar a la IA como una caja mágica de respuestas.</li>
                            <li><strong>Comienza:</strong> Rompe tareas complejas en pasos secuenciales (tuberías).</li>
                            <li><strong>Modelo Mental:</strong> La IA es un compilador. Entrada vaga = salida rota.</li>
                            <li><strong>Ejercicio:</strong> Toma tu próxima tarea de IA y divídela en 5 pasos distintos antes de comenzar.</li>
                        </ul>
                    </div>
                `
            },
            {
                title: "Buenos Hábitos: El Estándar Profesional",
                slug: "good-habits",
                content: `
                    <h3>Por Qué los Hábitos Importan Más Que el Talento</h3>
                    <p>Aquí hay una verdad que la mayoría de la gente no quiere escuchar: <strong>La IA amplifica lo que ya está ahí.</strong></p>
                    <p>Si eres un pensador claro, la IA te hace más rápido. Si eres un pensador descuidado, la IA te hace más rápido siendo descuidado. A la herramienta no le importa. Responde a lo que le das.</p>
                    <p>Es por eso que los hábitos importan más que el talento en la era de la IA. Una persona con talento mediocre pero excelentes hábitos superará a un genio con hábitos terribles. Todas las veces.</p>

                    <h3>Hábito 1: Planifica Antes de Escribir (Prompt)</h3>
                    <p>Antes de escribir un solo carácter en una interfaz de IA, responde dos preguntas:</p>
                    <ol>
                        <li><strong>¿Cuál es el resultado?</strong> No lo que estás haciendo. Lo que estás tratando de lograr.</li>
                        <li><strong>¿Cuáles son las restricciones?</strong> ¿Cuáles son los límites? ¿Qué NO debería hacer?</li>
                    </ol>
                    
                    <blockquote style="border-left: 4px solid #4f46e5; padding-left: 1rem; font-style: italic; margin: 1.5rem 0;">
                        Si no puedes explicarlo en viñetas, no puedes construirlo con IA.
                    </blockquote>

                    <h3>Hábito 2: Registra Todo (Log Everything)</h3>
                    <p>El código generado por IA tiene una propiedad peligrosa: <strong>miente silenciosamente.</strong></p>
                    <p>Cuando el código humano falla, generalmente falla ruidosamente. Cuando el código de IA falla, a menudo falla en silencio. Parece correcto. Se ejecuta sin errores. Pero hace lo incorrecto.</p>
                    <p>El estándar profesional es registrar todo: entradas, salidas, decisiones y errores.</p>

                    <h3>Hábito 3: Commits Atómicos</h3>
                    <p>La IA fomenta una velocidad imprudente. Puedes generar mil líneas de código en minutos. Esto es poderoso y peligroso.</p>
                    <p>El antídoto son los <strong>commits atómicos</strong>. Una característica. Una corrección de errores. Una refactorización. No todo mezclado.</p>
                    
                    <blockquote style="border-left: 4px solid #4f46e5; padding-left: 1rem; font-style: italic; margin: 1.5rem 0;">
                        La velocidad sin control es solo caos llegando temprano.
                    </blockquote>

                    <h3>Hábito 4: Confiar pero Verificar</h3>
                    <p>La IA es segura de sí misma. A veces irritantemente. Te dirá con absoluta certeza que el código es correcto - y estará completamente equivocada.</p>
                    <p><strong>La confianza no es corrección.</strong></p>
                    <ul>
                        <li><strong>Ejecuta el código.</strong> Nunca aceptes código que no hayas ejecutado.</li>
                        <li><strong>Prueba casos extremos.</strong> ¿Qué pasa con entradas vacías? ¿Valores nulos?</li>
                        <li><strong>Pide explicación.</strong> Dile a la IA: Explica por qué esto es correcto y dónde podría fallar.</li>
                    </ul>

                    <h3>Hábito 5: Control de Versiones desde el Día Uno</h3>
                    <p>Si estás construyendo algo con IA, necesitas control de versiones. No eventualmente. Desde el día uno.</p>
                    <p>El comando que necesitas: <code>git add . && git commit -m "Descripción del cambio"</code></p>
                    <p>Haz commit temprano. Haz commit a menudo. Haz commit con mensajes significativos.</p>

                    <hr style="margin: 2rem 0; border-color: rgba(255,255,255,0.1);"/>
                    
                    <h3>La Filosofía Central</h3>
                    <ol>
                        <li><strong>Sistemas sobre prompts</strong> - Piensa en flujos de trabajo, no en preguntas individuales.</li>
                        <li><strong>Estructura sobre astucia</strong> - Lo claro vence a lo creativo. Siempre.</li>
                        <li><strong>Verificación sobre fe</strong> - La confianza se gana a través de pruebas.</li>
                        <li><strong>Envío sobre teoría</strong> - Las ideas no valen nada. La ejecución lo es todo.</li>
                    </ol>
                    <p>Este no es un curso sobre <em>usar IA</em>. Este es un curso sobre <strong>volverse peligroso con ella</strong>.</p>
                    
                    <div class="glass-panel" style="padding: 1.5rem; margin: 2rem 0; background: linear-gradient(135deg, rgba(79,70,229,0.1) 0%, rgba(147,51,234,0.1) 100%);">
                        <h4 style="margin-top: 0;">Hoja de Ruta de Inicio Rápido</h4>
                        <ul>
                            <li><strong>Antes de promptear:</strong> Escribe tu objetivo y tres restricciones.</li>
                            <li><strong>Durante la codificación:</strong> Agrega console.log para entradas y salidas.</li>
                            <li><strong>Después de cada característica:</strong> Haz un commit atómico con un mensaje claro.</li>
                            <li><strong>Cuando la IA te da código:</strong> Ejecútalo, pruébalo, pídele a la IA que lo explique.</li>
                            <li><strong>Hábito diario:</strong> git add . && git commit -m "Instantánea de fin de sesión"</li>
                        </ul>
                    </div>
                `
            },
...
`
            ...
            {
                title: "El Método ConstantPrompt",
                slug: "constantprompt-method",
                content: `
                    <h3>El Problema: La IA Tiene Amnesia</h3>
                    <p>Aquí hay algo que te costará horas si no lo abordas temprano: <strong>La IA olvida todo entre sesiones.</strong></p>
                    <p>Cada nuevo chat es una pizarra en blanco. Cada nueva conversación comienza desde cero. La IA no recuerda la estructura de tu proyecto, tus preferencias de codificación, tus decisiones de diseño o el contexto que has construido con el tiempo.</p>
                    <p>Esto no es un error. Es cómo funcionan estos sistemas. Y si no lo planificas, pasarás más tiempo re-explicando tu proyecto que construyéndolo.</p>
                    <p>La solución es engañosamente simple: <strong>Escríbelo una vez, inyéctalo cada vez.</strong></p>

                    <h3>¿Qué es un ConstantPrompt?</h3>
                    <p>Un ConstantPrompt es un documento persistente que vive en tu proyecto. Contiene todo lo que la IA necesita saber para trabajar en tu base de código sin que tengas que explicarlo en cada sesión.</p>
                    <p>Piensa en ello como un documento informativo para un nuevo miembro del equipo que se une cada día sin memoria de ayer. No re-explicarías toda tu arquitectura cada mañana. Les entregarías un documento.</p>
                    <p>Ese documento es tu ConstantPrompt.</p>

                    <div class="glass-panel" style="padding: 1.5rem; margin: 1.5rem 0;">
                        <p><strong>Lo Que Contiene un ConstantPrompt:</strong></p>
                        <ul>
                            <li><strong>Resumen del Proyecto:</strong> ¿Qué es este proyecto? ¿Qué problema resuelve?</li>
                            <li><strong>Stack Técnico:</strong> ¿Qué frameworks, lenguajes y herramientas se usan?</li>
                            <li><strong>Reglas de Arquitectura:</strong> ¿Cómo se organiza el código? ¿Qué patrones seguimos?</li>
                            <li><strong>Guías de Estilo:</strong> ¿Cómo se debe formatear el código? ¿Qué convenciones de nomenclatura aplican?</li>
                            <li><strong>Estado Actual:</strong> ¿Qué características existen? ¿Qué está en progreso?</li>
                            <li><strong>Fuera de Límites:</strong> ¿Qué NO debe tocar o cambiar la IA?</li>
                        </ul>
                    </div>

                    <h3>Por Qué Esto Cambia Todo</h3>
                    <p>Sin un ConstantPrompt, cada sesión de IA comienza con fricción:</p>
                    <ul>
                        <li>Tú: Aquí está mi proyecto. Usamos React con TypeScript. Los componentes están en src/components. Tenemos un archivo de datos que...</li>
                        <li>IA: (Intenta ayudar con contexto incompleto)</li>
                        <li>Tú: (Gastas 10 minutos corrigiendo suposiciones)</li>
                    </ul>
                    <p>Con un ConstantPrompt:</p>
                    <ul>
                        <li>Tú: (Pegas ConstantPrompt) Agrega una nueva característica a la barra lateral.</li>
                        <li>IA: (Ya conoce el proyecto, produce código correcto inmediatamente)</li>
                    </ul>
                    <p>El tiempo ahorrado se acumula. En una semana de desarrollo, ahorras horas. En un mes, ahorras días.</p>

                    <h3>Cómo Crear Tu ConstantPrompt</h3>
                    <p>Crea una carpeta llamada <code>.constantprompt</code> en la raíz de tu proyecto. Dentro, crea un archivo llamado <code>constantprompt.md</code>.</p>
                    <p>Empieza simple. Siempre puedes agregar más tarde. Aquí hay una plantilla mínima:</p>
                    ...
                    <h3>Avanzado: Mapas de Arquitectura</h3>
                    <p>A medida que tu proyecto crece, agrega un mapa de arquitectura. Este es un diagrama visual o textual que muestra cómo encajan las piezas.</p>
                    <p>Guárdalo en <code>/docs/ARCHITECTURE.md</code> y haz referencia a él desde tu ConstantPrompt.</p>
                    <p>Cuando la IA puede ver el panorama completo, toma mejores decisiones sobre dónde debe vivir el nuevo código.</p>

                    <h3>La Disciplina: Mantenlo Actualizado</h3>
                    <p>Un ConstantPrompt solo funciona si refleja la realidad. Cuando haces cambios importantes:</p>
                    <ol>
                        <li>Actualiza el ConstantPrompt</li>
                        <li>Actualiza el Mapa de Arquitectura</li>
                        <li>Haz commit de ambos con tus cambios de código</li>
                    </ol>
                    <p>Esto toma 2 minutos. Ahorra horas de confusión en futuras sesiones.</p>

                    <blockquote style="border-left: 4px solid #4f46e5; padding-left: 1rem; font-style: italic; margin: 1.5rem 0;">
                        Los mejores desarrolladores no son los que escriben más código. Son los que mantienen el contexto más claro.
                    </blockquote>

                    <h3>Usando Tu ConstantPrompt</h3>
                    <p>Al comienzo de cada sesión de IA:</p>
                    <ol>
                        <li>Abre tu archivo ConstantPrompt</li>
                        <li>Pégalo en el chat de IA (o haz referencia a él si tu herramienta admite acceso a archivos)</li>
                        <li>Luego da tu instrucción real</li>
                    </ol>
                    <p>Algunas herramientas de IA (como Cursor, Claude Desktop con MCP) pueden leer archivos directamente. En esos casos, solo dile a la IA: Lee .constantprompt/constantprompt.md antes de continuar.</p>

                    <h3>El Meta-Beneficio: Te Vuelves Más Claro</h3>
                    <p>Escribir un ConstantPrompt te obliga a articular tu proyecto claramente. Esta claridad es valiosa más allá de las sesiones de IA.</p>
                    <p>Ayuda a incorporar colaboradores humanos. Te ayuda a recordar tus propias decisiones. Te obliga a confrontar la deuda arquitectónica.</p>
                    <p>El ConstantPrompt no es solo para la IA. Es para tu yo futuro.</p>
                    
                    <div class="glass-panel" style="padding: 1.5rem; margin: 2rem 0; background: linear-gradient(135deg, rgba(79,70,229,0.1) 0%, rgba(147,51,234,0.1) 100%);">
                        <h4 style="margin-top: 0;">Hoja de Ruta de Inicio Rápido</h4>
                        <ul>
                            <li><strong>Crear:</strong> Haz <code>.constantprompt/constantprompt.md</code> en la raíz de tu proyecto.</li>
                            <li><strong>Incluir:</strong> Resumen, stack técnico, estructura, reglas, estado actual.</li>
                            <li><strong>Usar:</strong> Pega o referencia al inicio de cada sesión de IA.</li>
                            <li><strong>Mantener:</strong> Actualiza cuando hagas cambios importantes. Haz commit con código.</li>
                            <li><strong>Bonus:</strong> Agrega <code>/docs/ARCHITECTURE.md</code> para proyectos complejos.</li>
                        </ul>
                    </div>
                `
            }]
